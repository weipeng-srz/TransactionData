...
export const US_INDEXES: USIndexDefinition[] = [
  { id: "dow", code: "DJI", name: "道琼斯工业指数", cashSymbol: "gb_$dji", extendedSymbol: "gb_dia", extendedCode: "DIA", futureSymbol: "hf_YM", futureCode: "YM", futureName: "道指期货", map: { longitude: -74.0113, latitude: 40.7069, anchor: "bottom" } },
